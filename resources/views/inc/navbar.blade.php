<nav class="navbar navbar-expand-md navbar-dark bg-secondary border-bottom sticky-top" id="navbar">
  <div class="container">
    <a href="{{URL('/')}}" class="navbar-brand">
      <img src="{{asset('images/logo/joblister.png')}}" alt="JobLister" class="img-fluid">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown dropdown-left"> 
          ...
          <div class="dropdown-menu dropdown-menu-right bg-secondary shadow animated--grow-in" aria-labelledby="userDropdown"> 
            @role('admin')
